...
const FRAUD_STATUTES: StatuteEntry[] = [
  ...
  },
  {
    ...
    guidelines: ['2B1.1', '2X1.1'],
    confidence: V,
    groupingClass: 'fraud',
    note: 'Penalties are those of the object offense.',
  },
  {
    id: '18:641',
...
const OTHER_STATUTES: StatuteEntry[] = [
  ...
  },
  {
    ...
    groupingClass: 'other',
    penalty: { minMonths: 0, maxMonths: 60 },
    note: 'Appendix A directs to the guideline for the substantive offense that was the object of the conspiracy.',
  },
  {
    id: '18:2251',
