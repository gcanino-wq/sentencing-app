...
const G_2C1_1: GuidelineDef = {
  ...
  socs: [
    ...
    },
    {
      ...
      label:
        'Public official who facilitated entry into the United States, or the obtaining of a passport, naturalization document, or government identification',
      levels: 2,
      citation: '§ 2C1.1(b)(4)',
      confidence: V,
    },
...
const G_2D1_1: GuidelineDef = {
  section: '2D1.1',
  title:
    'Unlawful Manufacturing, Importing, Exporting, or Trafficking; Attempt or Conspiracy',
  structured: true,
  confidence: V,
  summary:
    'Base level from the Drug Quantity Table on total converted drug weight, reduced where a mitigating role applies, then characteristics for weapons, violence, premises, fentanyl misrepresentation, and the safety-valve reduction.',
  quantityDriver: 'drug',
  groupsByQuantity: true,
  baseOptions: [
    {
      ...
      citation: '§ 2D1.1(a)(5)',
      confidence: V,
      note: 'Level is computed from the converted drug weight entered below, then reduced if a § 3B1.2 mitigating role applies.',
    },
    {
      id: 'a1',
      label: 'Offense carries a mandatory statutory term of life imprisonment',
      level: 43,
      citation: '§ 2D1.1(a)(1)',
      confidence: V,
      note: 'Under 21 U.S.C. § 841(b)(1)(A)–(C) or § 960(b)(1)–(3), or by stipulation.',
    },
    {
      id: 'a2',
      label: 'Offense carries a statutory term of not less than 20 years to life',
      level: 38,
      citation: '§ 2D1.1(a)(2)',
      confidence: V,
    },
    {
      id: 'a3',
      label: 'Offense under § 841(b)(1)(E) or § 960(b)(5) with a 30-year statutory maximum',
      level: 30,
      citation: '§ 2D1.1(a)(3)',
      confidence: V,
    },
    {
      id: 'a4',
      label: 'Offense under § 841(b)(1)(E) or § 960(b)(5) with a 15-year statutory maximum',
      level: 26,
      citation: '§ 2D1.1(a)(4)',
      confidence: V,
    },
  ...
  socs: [
    ...
    },
    {
      id: 'aircraft-vessel',
      label:
        'Import or export by non-commercial aircraft or submersible vessel, or the defendant served as pilot, captain, or navigator',
      levels: 2,
      citation: '§ 2D1.1(b)(3)',
      confidence: V,
      minimumLevel: 26,
    ...
    {
      id: 'prison',
      label: 'Object of the offense was distribution in a prison or detention facility',
      levels: 2,
      citation: '§ 2D1.1(b)(4)',
      confidence: V,
    },
    {
      id: 'meth-importation',
      label:
        'Importation of amphetamine or methamphetamine, or manufacture from unlawfully imported listed chemicals',
      levels: 2,
      citation: '§ 2D1.1(b)(5)',
      confidence: V,
      note: 'Unavailable where the defendant receives a § 3B1.2 mitigating role adjustment.',
    },
    {
      id: 'mass-marketing',
      label: 'Distribution through mass-marketing by means of an interactive computer service',
      levels: 2,
      citation: '§ 2D1.1(b)(7)',
      confidence: V,
    },
    {
      id: 'bribed-officer',
      label: 'Bribed, or attempted to bribe, a law enforcement officer',
      levels: 2,
      citation: '§ 2D1.1(b)(11)',
      confidence: V,
    },
    ...
    {
      id: 'fentanyl-misrepresented',
      label: 'Knowingly misrepresented or marketed fentanyl or a fentanyl analogue as another substance',
      levels: 4,
      citation: '§ 2D1.1(b)(13)(A)',
      confidence: V,
      exclusiveGroup: 'fentanyl',
    },
    {
      id: 'fentanyl-reckless',
      label:
        'Marketed fentanyl or an analogue as a legitimately manufactured drug, with reckless disregard',
      levels: 2,
      citation: '§ 2D1.1(b)(13)(B)',
      confidence: V,
      exclusiveGroup: 'fentanyl',
    },
    {
      id: 'hazardous',
      label: 'Unlawful discharge of a hazardous or toxic substance, or unlawful hazardous waste handling',
      levels: 2,
      citation: '§ 2D1.1(b)(14)(A)',
      confidence: V,
      exclusiveGroup: 'b14',
    },
    {
      id: 'minor-premises-distribute',
      label: 'Convicted under § 860a — distribution of methamphetamine where a minor is present',
      levels: 2,
      citation: '§ 2D1.1(b)(14)(B)',
      confidence: V,
      exclusiveGroup: 'b14',
      minimumLevel: 14,
    },
    {
      id: 'minor-premises-manufacture',
      label:
        'Manufacture of methamphetamine where a minor is present, or substantial risk of harm to human life or the environment',
      levels: 3,
      citation: '§ 2D1.1(b)(14)(C)',
      confidence: V,
      exclusiveGroup: 'b14',
      minimumLevel: 27,
    },
    {
      id: 'risk-to-minor',
      label: 'Manufacture creating a substantial risk of harm to the life of a minor or an incompetent',
      levels: 6,
      citation: '§ 2D1.1(b)(14)(D)',
      confidence: V,
      exclusiveGroup: 'b14',
      minimumLevel: 30,
    },
    {
      id: 'cultivation-public-land',
      label: 'Cultivation of marihuana on public or trespassed land, with an aggravating role',
      levels: 2,
      citation: '§ 2D1.1(b)(15)',
      confidence: V,
    },
    {
      id: 'super-aggravating',
      label: 'Aggravating role plus one or more of the § 2D1.1(b)(16) factors',
      levels: 2,
      citation: '§ 2D1.1(b)(16)',
      confidence: V,
      note: 'Recruitment through fear or affection, involving a vulnerable person, direct importation, obstruction, or a criminal livelihood.',
    },
    {
      id: 'coerced-minimal',
      label: 'Minimal participant motivated by an intimate or familial relationship, threats, or fear',
      levels: -2,
      citation: '§ 2D1.1(b)(17)',
      confidence: V,
      note: 'Requires the § 3B1.2(a) 4-level reduction, no monetary compensation, and minimal knowledge of the enterprise.',
    },
    {
  ...
  note: 'Under § 2D1.1(a)(5) a § 3B1.2 mitigating role reduces the Drug Quantity Table level: 32 drops 2, 34 drops 3, above 34 drops to 32, and a minimal participant lands at 30.',
};
...
const G_2L1_2: GuidelineDef = {
  ...
  confidence: V,
  summary:
    'Base level 8, with increases keyed to the sentences imposed for convictions before and after the first order of removal. Each set applies the greatest tier only.',
  quantityDriver: 'none',
  groupsByQuantity: false,
  baseOptions: [
    { id: 'a', label: 'Base offense level', level: 8, citation: '§ 2L1.2(a)', confidence: V },
  ],
  defaultBaseLevel: 8,
  socs: [
    {
      id: 'prior-illegal-reentry-felony',
      label: 'Prior conviction for a felony illegal reentry offense',
      levels: 4,
      citation: '§ 2L1.2(b)(1)(A)',
      confidence: V,
      exclusiveGroup: 'reentry',
    },
    {
      id: 'prior-1325a-misdemeanors',
      label: 'Two or more misdemeanor convictions under 8 U.S.C. § 1325(a)',
      levels: 2,
      citation: '§ 2L1.2(b)(1)(B)',
      confidence: V,
      exclusiveGroup: 'reentry',
    },
    {
      id: 'before-5y',
      label: 'Before the first removal order — felony (other than an illegal reentry offense) with a sentence of five years or more',
      levels: 10,
    ...
    {
      id: 'before-2y',
      label: 'Before the first removal order — felony (other than an illegal reentry offense) with a sentence of two years or more',
      levels: 8,
    ...
    {
      id: 'before-13m',
      label: 'Before the first removal order — felony (other than an illegal reentry offense) with a sentence exceeding one year and one month',
      levels: 6,
      citation: '§ 2L1.2(b)(2)(C)',
      confidence: V,
      exclusiveGroup: 'before',
    },
    {
      id: 'before-any',
      label: 'Before the first removal order — any other felony (other than an illegal reentry offense)',
      levels: 4,
      citation: '§ 2L1.2(b)(2)(D)',
      confidence: V,
      exclusiveGroup: 'before',
    },
    {
      id: 'before-misd',
      label: 'Before the first removal order — three or more misdemeanor convictions for crimes of violence or drug trafficking offenses',
      levels: 2,
      citation: '§ 2L1.2(b)(2)(E)',
      confidence: V,
      exclusiveGroup: 'before',
    },
    {
      id: 'after-5y',
      label: 'After the first removal order — felony (other than an illegal reentry offense) with a sentence of five years or more',
      levels: 10,
    ...
    {
      id: 'after-2y',
      label: 'After the first removal order — felony (other than an illegal reentry offense) with a sentence of two years or more',
      levels: 8,
    ...
    {
      id: 'after-13m',
      label: 'After the first removal order — felony (other than an illegal reentry offense) with a sentence exceeding one year and one month',
      levels: 6,
      citation: '§ 2L1.2(b)(3)(C)',
      confidence: V,
      exclusiveGroup: 'after',
    },
    {
      id: 'after-any',
      label: 'After the first removal order — any other felony (other than an illegal reentry offense)',
      levels: 4,
      citation: '§ 2L1.2(b)(3)(D)',
      confidence: V,
      exclusiveGroup: 'after',
    },
    {
      id: 'after-misd',
      label: 'After the first removal order — three or more misdemeanor convictions for crimes of violence or drug trafficking offenses',
      levels: 2,
      citation: '§ 2L1.2(b)(3)(E)',
      confidence: V,
      exclusiveGroup: 'after',
    },
  ],
  note: 'The 2016 restructure keyed these increases to the sentence imposed rather than the categorical nature of the prior. § 2L1.2(b)(1) applies the greater of its two tiers; (b)(2) and (b)(3) each apply the greatest of their five.',
};
  ...
  socs: [
    {
      ...
      label:
        'Knew or believed the funds were proceeds of, or intended to promote, a controlled substance offense, a crime of violence, or an offense involving firearms, explosives, national security, or the sexual exploitation of a minor',
      levels: 6,
      citation: '§ 2S1.1(b)(1)',
      confidence: V,
      note: 'Applies only where the base level came from § 2S1.1(a)(2).',
    },
    {
      id: 'convicted-1956',
    ...
    {
      id: 'business-of-laundering',
      label: 'In the business of laundering funds',
      levels: 4,
      citation: '§ 2S1.1(b)(2)(C)',
      confidence: V,
      exclusiveGroup: 'statute',
      note: 'Applies only where the base level came from § 2S1.1(a)(2).',
    },
  ...
  socs: [
    {
      id: 'criminal-income',
      label:
        'Failed to report or correctly identify income exceeding $10,000 in any year from criminal activity',
      levels: 2,
      citation: '§ 2T1.1(b)(1)',
      confidence: V,
      minimumLevel: 12,
